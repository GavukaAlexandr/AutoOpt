...
import {
  CreateCarParamsInput,
  UpdateUserCarParamsInput,
  UserCarParams,
} from './user.car.params.model';
...
export class UserCarParamsResolver {
  ...
  async createCarParams(
    @Args({ name: 'createCarParamsInput', type: () => CreateCarParamsInput })
    createCarParamsInput,
  ) {
    const {
      modelId,
  ...
  @Mutation(() => UserCarParams)
  async updateUserCarParams(
    @Args({
      name: 'updateUserCarParamsInput',
      type: () => UpdateUserCarParamsInput,
      nullable: true,
    })
    updateUserCarParamsInput,
  ) {
